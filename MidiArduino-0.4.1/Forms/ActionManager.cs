...
namespace MidiArduino.Forms
{
    public partial class ActionManager : Form
    {
        ...
        private void actionList_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 38)
            {
                if (actionList.SelectedIndices.Count == 0 || actionList.SelectedIndices[0] == 0) return;
                actionList.SelectItem(actionList.SelectedIndices[0] - 1);
            }
        ...
        private void duplicate()
        {
            ...
            actionControls.Add(actionControls[actionList.SelectedIndices[0]]);
        }
        ...
        public void updateIndex(int index)
        {
            ...
            {
                control.Index = index;
                control.actionIgniter.Index = index;
            }
            Index = index;
        }
